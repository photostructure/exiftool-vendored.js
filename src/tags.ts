...
import { ExifDate, ExifTime, ExifDateTime, ExifTimeZone } from './datetime'

// Autogenerated by "npm run mktags" by ExifTool 10.31 on Sun Oct 23 2016.
...
export interface FileTags {
  ...
  /** ★★★ ✔ {"year":2016,"month":10,"day":22,"hour":21,"minute":25,"second":42,"tzoffsetMin… */
...
export interface EXIFTags {
  ...
  /** ☆☆☆   "Measurement Active" */
  GPSStatus: string
  /** ☆☆☆ ✔ {"hour":16,"minute":27,"second":22,"tzoffsetMinutes":0,"millis":900} */
...
export interface MakerNotesTags {
  ...
  /** ☆☆☆   {"year":1970,"month":1,"day":1,"hour":15,"minute":11,"second":20,"millis":0} */
  DateTimeOriginal: ExifDateTime
  /** ☆☆☆   "Off" */
  ...
  /** ☆☆☆   "Body Battery" */
  PowerSource: string
  /** ☆☆☆ ✔ {"year":0,"month":0,"day":0,"hour":0,"minute":0,"second":0,"millis":0} */
  ...
  /** ☆☆☆   {"hour":6,"minute":22,"second":54,"millis":0} */
  Time: ExifTime
