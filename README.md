...
Tags marked with ★★★★, like [MIMEType](interfaces/_tags_.filetags#mimetype),
should be expected in most files. You'll find that **very few** tags are found
in general populations. You'll need to do your own research to determine which
tags are valid for your uses.
