...
1.  Support for
    ...
    - [reading tags](classes/exiftool.html#read)
    - extracting embedded binaries, like [thumbnail](classes/exiftool.html#extractthumbnail) and [preview](classes/exiftool.html#extractpreview) images
    - [writing tags](classes/exiftool.html#write)
    - [rescuing metadata](classes/exiftool.html#rewritealltags)
...
`ExifTool.read()` returns a Promise to a [Tags](interfaces/tags.html) instance. Note
...
The [Tags](interfaces/_tags_.tags) interface is autogenerated by the `mktags`
script, which parses through over 6,000 unique camera make and model images, in
large part sourced from the ExifTool site. `mktags` groups tags, extracts their
...
Tags marked with "★★★★", like [MIMEType](interfaces/filetags.html#mimetype),
