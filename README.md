...
1.  Support for
    ...
    - extracting embedded binaries, like [thumbnail images](classes/_exiftool_.exiftool#extractthumbnail)
...
Please review the [ExifTool constructor parameters](classes/_exiftool_.exiftool#constructor)
